...
<nav class="navbar navbar-expand-lg navcolor">
    ...
    <div class="padding-l container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul class="nav-menu">
                <li class="active links"><a class="nav-link" href="#accueil"><i class="bx bx-home"></i><span >Home</span></a></li>
                <li class="active links"><a class="nav-link" href="#propos"><i class="bx bx-home"></i><span >About me</span></a></li>
                <li class="active links"><a class="nav-link" href="#pro"><i class="bx bx-home"></i><span >Professional career</span></a></li>
                <li class="active links"><a class="nav-link" href="#sco"><i class="bx bx-home"></i><span >Education</span></a></li>
                <li class="active links"><a class="nav-link" href="#projets"><i class="bx bx-home"></i><span >Projects</span></a></li>
                <li class="active links"><a class="nav-link" href="#veille"><i class="bx bx-home"></i><span>Technology watch</span></a></li>
...
<main class="main">
    <div class="main-align">
        ...
        <section id="accueil" class="d-flex flex-column justify-content-center-padd align-items-center">
            ...
            <h3 class="h3Txt">Welcome on my portfolio</h3>
        </section>
        <!-- ======= END TITLE ======= -->
