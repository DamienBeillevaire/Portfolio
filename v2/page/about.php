<div class="defaultContainer">
    ...
    <div>
        ...
        <a class="padding-m" href="../../v2/page/ressources/pdf/About/CV.pdf" target="_blank" download="CV Damien Beillevaire"><button class="button-74" role="button">CV</button></a>
