<div class="defaultContainer">
    <div class="main-align">
        <div>
            <h2>Stage Acoss</h2>
            <a href="?route=stageAcoss" class="btn btn-primary">Redirection</a>
            <h3>Compétence travailler</h3>
            <div class="flex-card">
        ...
        <div>
            <h2>Stage Univers</h2>
            <a href="?route=stageUnivers" class="btn btn-primary">Redirection</a>
            <h3>Compétence travailler</h3>
            <div class="flex-card">
                <div class="card" style="width: 25rem;">
                    <h5 class="card-header">Gérer le patrimoine informatique</h5>
        ...
        <div>
            <h2>Discover API</h2>
            <a href="?route=ProjetDiscoverAPI" class="btn btn-primary">Redirection</a>
        ...
        <div>
            <h2>Discover Web</h2>
            <a href="?route=ProjetDiscoverWeb" class="btn btn-primary">Redirection</a>
            <h4>Compétence travailler</h4>
            <div class="flex-card">
                <div class="card" style="width: 25rem;">
                    <h5 class="card-header">Gérer le patrimoine informatique</h5>
        ...
        <div>
            <h2>Mangatek</h2>
            <a href="?route=ProjetMangatek" class="btn btn-primary">Redirection</a>
            <h4>Compétence travailler</h4>
            <div class="flex-card">
        ...
        <div>
            <h2>Portefolio</h2>
            <a href="?route=ProjetPortfolio" class="btn btn-primary">Redirection</a>
            <h4>Compétence travailler</h4>
            <div class="flex-card">
                <div class="card" style="width: 35rem;">
                    <h5 class="card-header">Gérer le patrimoine informatique</h5>
